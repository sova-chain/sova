...
export interface MineLogSummary {
  ...
  stoppedReason: "budget-exhausted" | "max-epochs-reached" | null;
  warnings: string[];
}

export function summarizeMineLog(logContent: string): MineLogSummary {
  let epochsCompleted = 0;
  let lastEpoch: MineLogSummary["lastEpoch"] = null;
  let stoppedReason: MineLogSummary["stoppedReason"] = null;
