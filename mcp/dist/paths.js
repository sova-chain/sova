...
export const MINER_BIN = process.env.SOVA_MINER_BIN ??
    path.join(REPO_ROOT_DIR, "crates", "burn-wallet", "target", "release", "sova-miner");
...
export const DATA_ROOT = process.env.SOVA_MCP_DATA_DIR ?? path.join(MCP_DIR, ".data");
